...
import NovPresentation from '$lib/info/NovPresentation.svelte'
import OctPresentation from '$lib/info/OctPresentation.svelte'
import Soldout from '$lib/info/Soldout.svelte'
import Precautions from '$lib/info/Precautions.svelte'
import MeetToGo from '$lib/info/MeetToGo.svelte'
